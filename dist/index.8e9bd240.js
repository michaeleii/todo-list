...
const addToList = ()=>{
    ...
    const toDoList = new (0, _todoList.ToDoList)();
    const toDo = new (0, _todo.ToDo)(title.value, description.value, dueDate.valueAsDate, selectedPriority);
    toDoList.addToDo(toDo);
    console.log(toDoList.getToDoList());
};
addButton.addEventListener("click", addToList);

},{"./todo":"92xLS","./todo-list":"boThw"}],"92xLS":[function(require,module,exports) {
...
},{}],"boThw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6AjTz","1jwFz"], "1jwFz", "parcelRequire5b66")
